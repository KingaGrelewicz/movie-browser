...
import { ReactComponent as PosterIcon } from "../../../../images/Profile.svg";export const PopularPeopleHeaderWrapper = styled.div`
  max-width: 1368px;
  margin: 0 auto;
`;export const PopularPeopleHeader = styled.h1`
  font-size: 36px;
  font-style: bold;  @media (max-width: ${mediaQuery.breakpoints.tabletHorizontalMax}px) {
    font-size: 32px;
    margin: 24px 16px;
...
`;export const PopularPeoplePhoto = styled.img`
  ...
  padding: 16px;
  border-radius: 20px;
  display: block;  @media (max-width: ${mediaQuery.breakpoints.tabletHorizontalMax}px) {
    padding: 14px;
  }  @media (max-width: ${mediaQuery.breakpoints.tabletVerticalMax}px) {
    padding: 12px;
  }  @media (max-width: ${mediaQuery.breakpoints.mobileMax}px) {
...
`;export const PopularPeopleDefaultPoster = styled.div`
  ...
  border-radius: 5px;
  margin: 16px;
  background: ${({ theme }) => theme.color.silver};  @media (max-width: ${mediaQuery.breakpoints.tabletHorizontalMax}px) {
    width: 150px;
    height: 225px;
    padding: 0;
  }  @media (max-width: ${mediaQuery.breakpoints.tabletVerticalMax}px) {
...
`;export const PopularPeopleName = styled.h2`
  ...
  text-align: center;  @media (max-width: ${mediaQuery.breakpoints.tabletVerticalMax}px) {
    font-size: 16px;
  }  @media (max-width: ${mediaQuery.breakpoints.mobileMax}px) {
    font-size: 14px;
    padding: 8px;
